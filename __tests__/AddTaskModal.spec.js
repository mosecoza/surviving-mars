...
test("opens modal when isOpen prop is true", () => {
  ...
  expect(modal.className).toMatchSnapshot(
    "block overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full"
  );
});
